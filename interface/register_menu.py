...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame.setMaximumSize(QtCore.QSize(500, 90))
...
"background-color: rgb(112, 112, 112);")
        ...
        self.buttonConfirm.setMinimumSize(QtCore.QSize(200, 60))
        ...
        self.buttonCancel.setMinimumSize(QtCore.QSize(200, 60))
